      ...
      <form id="form" method="post">
        ...
        <div class="row">
          <div class="col-sm-4">
            ...
            <div class="input-group input-group-outline">
              <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Orang Tua / Wali" />
            </div>
          </div>
          <div class="col-sm-4">
            <label for="" class="col-form-label me-3">Nomor Telp Orang Tua / Wali :</label>
            <div class="input-group input-group-outline">
              <input type="tel" name="nik" class="form-control" placeholder="Masukan Nomor Telephone Orang Tua / Wali" />
            </div>
          </div>
